...
/**
 * @title SmartLendIncentivesController
 * @notice Distributor contract for rewards to the SmartLend protocol
 * @author SmartLend
 **/
contract SmartLendIncentivesController is
    ISmartLendIncentivesController,
    ...
    SmartLendDistributionManager
{
    ...
    IStakedSmartLend public immutable PSM;
    ...
    function getRewardsBalance(
        ...
        for (uint256 i = 0; i < assets.length; i++) {
            ...
            (userState[i].stakedByUser, userState[i].totalStaked) = IAToken(
                assets[i]
