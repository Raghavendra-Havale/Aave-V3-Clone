 ...
 * @author SmartLend
 * @notice Main registry of PoolAddressesProvider of SmartLend markets.
 * @dev Used for indexing purposes of SmartLend protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the SmartLend main market and `2` for the next created.
 */
