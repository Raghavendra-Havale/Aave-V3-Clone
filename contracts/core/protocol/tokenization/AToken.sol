...
import {VersionedInitializable} from "../libraries/smartlend-upgradeability/VersionedInitializable.sol";
...
/**
 * @title SmartLend ERC20 AToken
 * @author SmartLend
 * @notice Implementation of the interest bearing token for the SmartLend protocol
 */
contract AToken is
    ...
    IAToken
{
    ...
    function initialize(
        ...
        ISmartLendIncentivesController incentivesController,
