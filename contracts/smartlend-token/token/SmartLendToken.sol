 ...
 * @author SmartLend
 */
contract SmartLendToken is ERC20, VersionedInitializable {
    ...
    string internal constant NAME = "SmartLend Token";
    string internal constant SYMBOL = "SmartLend";
    uint8 internal constant DECIMALS = 18;

    /// @dev the amount being distributed for the LEND -> SmartLend migration
    ...
    /// to control all potential reentrancies by calling back the SmartLendToken
     ...
     * @param migrator the address of the LEND -> SmartLend migration contract
     * @param distributor the address of the SmartLend distribution contract
     */
    function initialize(
        address migrator,
        address distributor,
