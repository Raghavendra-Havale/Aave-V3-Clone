...
import {VersionedInitializable} from "../../core/protocol/libraries/smartlend-upgradeability/VersionedInitializable.sol";
import {SafeCast} from "../../core/dependencies/openzeppelin/contracts/SafeCast.sol";
import {IScaledBalanceToken} from "../../core/interfaces/IScaledBalanceToken.sol";
    ...
    IRewardsController
{
    ...
    // the current SmartLend UI without the need to setup an external price registry
