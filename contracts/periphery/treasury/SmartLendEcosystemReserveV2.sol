...
/**
 * @title SmartLendEcosystemReserve v2
 ...
 * Modifications:
 * - Sablier "pulls" the funds from the creator of the stream at creation. In the SmartLend case, we already have the funds.
 * - Anybody can create streams on Sablier. Here, only the funds admin (SmartLend governance via controller) can
 ...
 * @author BGD Labs
 **/
contract SmartLendEcosystemReserveV2 is
