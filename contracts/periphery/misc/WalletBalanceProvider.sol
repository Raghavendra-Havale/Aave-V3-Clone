...
import {Address} from "../../core/dependencies/openzeppelin/contracts/Address.sol";
import {IPoolAddressesProvider} from "../../core/interfaces/IPoolAddressesProvider.sol";
import {IPool} from "../../core/interfaces/IPool.sol";
import {GPv2SafeERC20} from "../../core/dependencies/gnosis/contracts/GPv2SafeERC20.sol";
 ...
 * @author SmartLend, influenced by https://github.com/wbobeirne/eth-balance-checker/blob/master/contracts/BalanceChecker.sol
 * @notice Implements a logic of getting multiple tokens balance for one user address
 * @dev NOTE: THIS CONTRACT IS NOT USED WITHIN THE SmartLend PROTOCOL. It's an accessory contract used to reduce the number of calls
 * towards the blockchain from the SmartLend backend.
 **/
