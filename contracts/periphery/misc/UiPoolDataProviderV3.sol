...
import {IERC20Detailed} from "../../core/dependencies/openzeppelin/contracts/IERC20Detailed.sol";
import {IPoolAddressesProvider} from "../../core/interfaces/IPoolAddressesProvider.sol";
import {IPool} from "../../core/interfaces/IPool.sol";
import {ISmartLendOracle} from "../../core/interfaces/ISmartLendOracle.sol";
import {IAToken} from "../../core/interfaces/IAToken.sol";
import {IVariableDebtToken} from "../../core/interfaces/IVariableDebtToken.sol";
import {IStableDebtToken} from "../../core/interfaces/IStableDebtToken.sol";
import {DefaultReserveInterestRateStrategy} from "../../core/protocol/pool/DefaultReserveInterestRateStrategy.sol";
import {SmartLendProtocolDataProvider} from "../../core/misc/SmartLendProtocolDataProvider.sol";
...
contract UiPoolDataProviderV3 is IUiPoolDataProviderV3 {
    ...
    {
        ISmartLendOracle oracle = ISmartLendOracle(provider.getPriceOracle());
        IPool pool = IPool(provider.getPool());
        SmartLendProtocolDataProvider poolDataProvider = SmartLendProtocolDataProvider(
