...
export const ORACLE_ID = `SmartLendOracle-${MARKET_NAME}`;
...
export const SMARTLEND_COLLECTOR_PROXY_ID = `SmartLendCollector-${PROXY_ID}-${MARKET_NAME}`;
export const SMARTLEND_COLLECTOR_IMPL_ID = `SmartLendCollector-${IMPL_ID}-${MARKET_NAME}`;
...
export const STAKE_SMARTLEND_PROXY = `StakeSmartLend-${PROXY_ID}`;
export const STAKE_SMARTLEND_IMPL_V1 = `StakeSmartLend-REV-1-${IMPL_ID}`;
export const STAKE_SMARTLEND_IMPL_V2 = `StakeSmartLend-REV-2-${IMPL_ID}`;
export const STAKE_SMARTLEND_IMPL_V3 = `StakeSmartLend-REV-3-${IMPL_ID}`;
